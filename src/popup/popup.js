...
const BANDEIRAS_PAIS = {
  ...
  au: '<svg class="bandeira" viewBox="0 0 24 16"><rect width="24" height="16" fill="#012169"/><g stroke="#fff" stroke-width="1.5"><path d="M0 0l12 8M12 0L0 8"/></g><g stroke="#c8102e" stroke-width="0.9"><path d="M0 0l12 8M12 0L0 8"/></g><path d="M6 0v8M0 4h12" stroke="#fff" stroke-width="2.6"/><path d="M6 0v8M0 4h12" stroke="#c8102e" stroke-width="1.4"/><g fill="#fff"><circle cx="18" cy="4" r="1"/><circle cx="20.6" cy="8.4" r="0.8"/><circle cx="16.2" cy="10.6" r="0.7"/><circle cx="19" cy="12.6" r="0.6"/><circle cx="6" cy="12.8" r="1.1"/></g></svg>',
  jp: '<svg class="bandeira" viewBox="0 0 24 16"><rect width="24" height="16" fill="#fff"/><circle cx="12" cy="8" r="4.6" fill="#bc002d"/></svg>',
  kr: '<svg class="bandeira" viewBox="0 0 24 16"><rect width="24" height="16" fill="#fff"/><path d="M9.4 8a2.6 2.6 0 0 1 5.2 0z" fill="#cd2e3a"/><path d="M9.4 8a2.6 2.6 0 0 0 5.2 0z" fill="#0047a0"/><g stroke="#000" stroke-width="0.6"><path d="M3.4 4l1.8 2.6M4.6 3.2l1.8 2.6M19.4 12l-1.8-2.6M18.2 12.8l-1.8-2.6"/></g></svg>',
